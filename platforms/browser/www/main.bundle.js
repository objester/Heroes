...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__dashboard_component__ = __webpack_require__("../../../../../src/app/dashboard.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__heroes_component__ = __webpack_require__("../../../../../src/app/heroes.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_angular_in_memory_web_api__ = __webpack_require__("../../../../angular-in-memory-web-api/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__in_memory_data_service__ = __webpack_require__("../../../../../src/app/in-memory-data.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
// Imports for loading & configuring the in-memory web api
 //Need to run command 'npm i angular-in-memory-web-api' in folder
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* NgModule */])({
        imports: [
            ...
            //        },
            //        {
            //            path: 'heroes',             //Associates the part of the URL after the base
            //            component: HeroesComponent  //with the HeroesComponent or heroes.component.ts
            //        },
            //        {
            //            path: '',
        ...
        providers: [
            __WEBPACK_IMPORTED_MODULE_9__hero_service__["a" /* HeroService */]
        ],
        bootstrap: [
            __WEBPACK_IMPORTED_MODULE_4__app_component__["a" /* AppComponent */]
        ]
...
var HeroService = (function () {
    ...
    HeroService.prototype.getHero = function (id) {
        var url = this.heroesUrl + "/" + id; //These have to be left ticks, not single quotes!
    ...
    HeroService.prototype.update = function (hero) {
        var url = this.heroesUrl + "/" + hero.id; //These have to be left ticks, not single quotes!
...
var HeroesComponent = (function () {
    //The 'heroService' parameter simultaneously defines a private heroService property and identifies it as a
